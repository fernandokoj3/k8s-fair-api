...
export class FeiraLivreController {
  ...
  public async list(request: Request, response: Response): Promise<Response> {
    let result = await this.feiraLivreService.list(
      request?.query as unknown as FeiraLivreListRequest,
    );
  ...
  public async create(request: Request, response: Response): Promise<Response> {
    let result = await this.feiraLivreService.save(
      request.body as FeiraLivreCreateRequest,
    );
  ...
  @Patch(
    '/:id',
    getUrlParamValidator(FeiraRequestOneRequest),
    getBodyValidator(FeiraLivreMergeRequest),
  )
  ...
  public async remove(request: Request, response: Response) {
    ...
    return response
      .status(200)
      .send({ message: 'Fair removed with successful' });
  }
  ...
  public async restore(request: Request, response: Response) {
    ...
    return response
      .status(200)
      .send({ message: 'Fair restore with successful' });
  }
}
