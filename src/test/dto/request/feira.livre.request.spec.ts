...
import {
  ...
  getFeiraLivreListRequest,
  getFeiraRequestOneRequest,
} from '#/mocks';
import {
  FeiraLivreCreateRequest,
  FeiraLivreListRequest,
...
describe('feira.livre.request (...)', () => {
  describe('FeiraLivreCreateRequest (...) ', () => {
    ...
    test('numero should be must be a number', async () => {
      ...
      error.forEach(e =>
        expect(e.messages).toEqual(
          expect.arrayContaining([`${e.field} must be an integer number`]),
        ),
      );
    });
    ...
    test('referencia should be a string', async () => {
      ...
      error.forEach(e =>
        expect(e.messages).toEqual(
          expect.arrayContaining([`${e.field} must be a string`]),
        ),
      );
    });
  ...
  describe('FeiraLivreListRequest (...) ', () => {
    ...
    test('limit should be less than 10', async () => {
      ...
      error.forEach(e =>
        expect(e.messages).toEqual(
          expect.arrayContaining([`${e.field} must not be less than 10`]),
        ),
      );
    });
    ...
    test('limit should be greater than 100', async () => {
      ...
      error.forEach(e =>
        expect(e.messages).toEqual(
          expect.arrayContaining([`${e.field} must not be greater than 100`]),
        ),
      );
    });
  ...
  describe('FeiraRequestOneRequest (...) ', () => {
    ...
    test('id should be valid number as string', async () => {
      ...
      error.forEach(e =>
        expect(e.messages).toEqual(
          expect.arrayContaining([`${e.field} must be a valid number`]),
        ),
      );
    });
  });
  ...
  describe('FeiraLivreMergeRequest (...) ', () => {
    ...
    test('areaDePonderacao should be a bigint', async () => {
      ...
      error.forEach(e =>
        expect(e.messages).toEqual(
          expect.arrayContaining([`${e.field} must be a BigInt`]),
        ),
      );
    });
    ...
    test('regiao8 should be not a valid region and must be a string', async () => {
      ...
      error.forEach(e =>
        expect(e.messages).toEqual(
          expect.arrayContaining([`${e.field} must be a region with number`]),
        ),
      );
    });
